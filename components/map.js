...
export function Map() {
    let location = {
        latitude: 46.04999890020227, longitude: 14.46904593724097, latitudeDelta: 0.009, longitudeDelta: 0.009
    }
    ...
    return (<View
            ...
            <MapView
                ...
                mapType='hybrid'
                region={location}>
                {challenges.map((challenge, index) => (<Marker
                        key={index}
